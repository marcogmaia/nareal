...
class Reader extends Component {
  ...
  render() {
    return (
      <div id="page-container" class="container" onClick={(e) => { this.clickPage(e) }}>
        <Page book={this.props.book.bookTitle} title={this.props.book.chapterTitle} text={this.state.pages[this.state.pageNum]} pageNum={this.state.pageNum}></Page>
